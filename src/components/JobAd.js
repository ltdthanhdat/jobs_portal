				...
				<div className="w-11/12 mx-auto mt-20 pb-8">
					<div className="flex">
						...
						<div>
							...
							<h6 className="md:text-xl text-lg ">{"Công ty"}</h6>
						</div>
					</div>
					<div className="flex justify-between md:mt-12 mt-12 mb-3">
						<h1 className="text-3xl font-medium ">Tóm tắt công việc</h1>
					</div>
					<table className="table-auto w-full mb-3">
						<tbody className="text-xl">
							<tr>
								<td className="text-bold">Mức lương</td>
								<td className="text-right">{job.salary || ""} $</td>
							</tr>

							<tr>
								<td className="text-bold">Kỹ năng yêu cầu</td>
                          ...
                          bg-gray-900 py-1.5 px-3 font-sans text-xs font-bold uppercase text-white"
							...
							<tr>
								<td className="text-bold">Thời gian làm việc</td>
								<td className="text-right">{job.duration || ""}</td>
							</tr>
							<tr>
								<td className="text-bold">Hạn chót nộp hồ sơ</td>
								<td className="text-right">{job.deadline || ""}</td>
							</tr>
							<tr>
								<td className="text-bold">Số ứng viên tối đa</td>
								<td className="text-right">{job.maxApplicants || ""}</td>
							</tr>
							<tr>
								<td className="text-bold">Số ứng viên cần tuyển</td>
								<td className="text-right">{job.maxPositions || ""}</td>
							</tr>
							<tr>
								<td className="text-bold">Địa điểm làm việc</td>
								<td className="text-right">{job.location || ""}</td>
							</tr>
						</tbody>
					</table>
					<div className="my-8">
						<h1 className="text-3xl font-medium mb-2">Mô tả công việc</h1>
			...
			{edit && (
				<div className="w-11/12 mx-auto mt-20 pb-8">
					<div className="flex">
						...
						<div>
							<h1 className="font-semibold lg:text-4xl text-2xl mt-3">
								{edit?.title || "Tiêu đề công việc"}
							</h1>
							<h6 className="md:text-xl text-lg ">{"Công ty"}</h6>
						</div>
					</div>
					<div className="flex justify-between md:mt-12 mt-12 mb-3">
						<h1 className="text-3xl font-medium ">Tóm tắt</h1>
					</div>
					<table className="table-auto w-full mb-3">
						<tbody className="text-xl">
							<tr>
                          ...
                          bg-gray-900 py-1.5 px-3 font-sans text-xs font-bold uppercase text-white"
							...
							<tr>
								<td className="text-bold">Hạn nộp hồ sơ</td>
							...
							<tr>
								<td className="text-bold">Số vị trí cần tuyển</td>
					...
					<div className="my-8">
						<h1 className="text-3xl font-medium mb-2">Thông tin công việc</h1>
                          ...
                          bg-gray-900 py-1.5 px-3 font-sans text-xs font-bold uppercase text-white"
							...
							<div className="w-full flex flex-wrap md:flex-row gap-2 items-center justify-between my-10">
								...
								<div className="bg-[#fed0ab] w-40 h-16 px-6 rounded-lg flex flex-col items-center justify-center">
									<span className="text-sm">Số ứng viên</span>
									<p className="text-lg font-semibold text-gray-700">
										{about.maxApplicants}
									</p>
								</div>
								...
								<div className="bg-[#cecdff] w-40 h-16 px-6 rounded-lg flex flex-col items-center justify-center">
									<span className="text-sm">Số lượng tuyển</span>
									<p className="text-lg font-semibold text-gray-700">
										{about.maxPositions}
									</p>
								</div>
							...
							<div className="flex justify-center items-center">
								...
								>
									<span className="text-sm">Vị trí còn lại</span>
									<p className="text-lg font-semibold text-gray-700">
							...
							<div className="my-6">
								<>
									<p className="text-xl font-semibold">Thông tin công việc</p>
