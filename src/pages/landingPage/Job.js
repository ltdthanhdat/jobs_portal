	...
	const handleApply = () => {
		...
		if (userApply()) {
			setPopup({
				...
				icon: "success",
				message:
					"Bạn đã có công việc được chấp nhận. Không thể ứng tuyển công việc khác.",
			});
			return;
		}
		...
		<>
			<div className="flex">
				...
				<div className="w-full md:w-1/3 2xl:w-2/4 md:mt-20 mt-10 pb-10">
					<p className="text-gray-500 font-semibold">Công việc tương tự</p>
											...
											<div className="py-3">
												<p className="text-sm">
													{job.recruiter.bio ? (
														...
														<div className="text-base">Chưa có mô tả</div>
													)}
												</p>
											</div>
			...
			<Banner
				title="Bạn đang tìm kiếm công việc khác?"
